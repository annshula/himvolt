...
export const faqGroups: FaqGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...homepageFaqs
        .filter(
          (f) =>
            f.q === "Will it fit my wrist?" ||
            f.q === "Is this real stone or a coated bead?" ||
            f.q === "What are the benefits of a hematite bracelet?",
        )
        .map((f) => ({ q: f.q, a: f.a })),
      {
  ...
  },
  {
    ...
    items: homepageFaqs
      .filter(
        (f) =>
          f.q.startsWith("How long does delivery") ||
          f.q.startsWith("What if I don't like it"),
      )
      .map((f) => ({ q: f.q, a: f.a })),
  },
  {
